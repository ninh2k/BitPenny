...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitpenny-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitpenny-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitpenny transaction") + "\n" +
              "  bitpenny-tx [options] -create [commands]   " + _("Create hex-encoded bitpenny transaction") + "\n" +
              "\n";
