...
const char * const BITCOIN_CONF_FILENAME = "bitpenny.conf";
const char * const BITCOIN_PID_FILENAME = "bitpenny.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitPenny";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BitPenny";
#else
    // Unix
