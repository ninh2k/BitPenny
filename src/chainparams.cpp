...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.bitpenny.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.bitpennytools.com", true);
        vSeeds.emplace_back("dnsseed.bitpennypool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bitpennytools.com", true);
        vSeeds.emplace_back("seed-b.bitpenny.loshan.co.uk", true);
